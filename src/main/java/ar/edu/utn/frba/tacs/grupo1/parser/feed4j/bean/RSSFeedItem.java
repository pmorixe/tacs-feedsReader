 ...
 */
public class RSSFeedItem extends RawElement {
	 ...
	 *            The item enclosure.
	 */
	public void addEnclosure(RSSFeedEnclosure enclosure) {
		if (enclosures == null) {
	 ...
	 *             getEnclosureCount().
	 */
	public RSSFeedEnclosure getEnclosure(int index)
			throws IndexOutOfBoundsException {
		if (enclosures == null) {
			throw new IndexOutOfBoundsException();
		} else {
			return (RSSFeedEnclosure) enclosures.get(index);
		}
	}
