...
<!-- <form class="form-signin"  method ="post" action="connect/facebook" style="max-width: 280px;"> -->
		<p>
        ...
        <a href="/login-fb" class="btn btn-lg btn-primary btn-block" type="submit">Connect with Facebook</a>
      </form>
